...
import { TFighterProperty } from "../definations/types";
...
export const FIGHTER_PROPERTIES: IObject<TFighterProperty> = {
  HEIGHT: "height",
  WEIGHT: "weight",
  WIN: "win",
  LOSE: "lose",
...
export const FIGHTER_LABELS: IObject<{ label: string; key: TFighterProperty }> =
  {
    [FIGHTER_PROPERTIES.HEIGHT]: {
      label: "Height",
